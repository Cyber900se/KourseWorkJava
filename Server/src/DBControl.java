    ...
    public static String fetchOrders() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                response.append(id).append(";").append(product).append(";").append(supplier).append(";").append(quantity).append(";").append(deliveryDate).append(";");
            }
            rs.close();
            st.close();
            con.close();
    ...
    public static String fetchMenu() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                response.append(id).append(";").append(name).append(";").append(serving).append(";").append(price).append(";");
            }
            rs.close();
            st.close();
            con.close();
    ...
    public static String fetchEmployees() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                response.append(id).append(";").append(name).append(";").append(position).append(";").append(password).append(";");
            }
            rs.close();
            st.close();
            con.close();
